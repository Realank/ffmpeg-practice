...
- (IBAction)clickDecodeButton:(id)sender {
    ...
    NSString *output_str= [[NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"movie.yuv"];
    
//    NSString *input_nsstr=[[[NSBundle mainBundle]resourcePath] stringByAppendingPathComponent:input_str];
//    NSString *output_nsstr=[[[NSBundle mainBundle]resourcePath] stringByAppendingPathComponent:output_str];
    NSString *input_nsstr = input_str;
    NSString *output_nsstr = output_str;
